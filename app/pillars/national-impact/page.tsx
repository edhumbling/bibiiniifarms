        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 h-full">
          <div className="h-full w-full flex flex-col items-center justify-center text-center">
            ...
            <p className="text-xl text-white/90 max-w-3xl mx-auto">
              Creating positive impact across Ghana through job creation, economic development, and strengthening local food systems.
            </p>
          </div>
        </div>
      </section>
          ...
          <Reveal>
            <div className="bg-red-50 border border-red-200 rounded-xl p-12">
              ...
              <p className="text-lg text-gray-600 mb-8">
                We're working on detailed content about our national impact initiatives. This page will showcase how Bibinii Farms contributes to Ghana's economic development and food security.
              </p>
              <Link
                href="/"
                className="inline-flex items-center justify-center px-8 py-3 rounded-md bg-red-600 text-white font-semibold shadow-sm hover:shadow-md transition-shadow"
              >
                Return Home
              </Link>
            </div>
