        ...
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
          ...
          <Reveal>
            <div className="text-center mb-12 sm:mb-16">
              <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-4 sm:mb-6">Building Ghana's Food Independence</h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 sm:gap-8 mb-12 sm:mb-16">
            ...
            <Reveal delay={0.1}>
              <div className="bg-gradient-to-br from-red-50 to-rose-100 rounded-xl p-6 sm:p-8 border border-red-200">
                <div className="flex items-center mb-4">
                  ...
                  <h3 className="text-lg sm:text-xl font-bold text-gray-900">Reducing Imports</h3>
                </div>
            ...
            <Reveal delay={0.2}>
              <div className="bg-gradient-to-br from-blue-50 to-cyan-100 rounded-xl p-6 sm:p-8 border border-blue-200">
                <div className="flex items-center mb-4">
                  ...
                  <h3 className="text-lg sm:text-xl font-bold text-gray-900">Job Creation</h3>
                </div>
                <p className="text-gray-700 leading-relaxed text-sm sm:text-base">
            ...
            <Reveal delay={0.3}>
              <div className="bg-gradient-to-br from-green-50 to-emerald-100 rounded-xl p-6 sm:p-8 border border-green-200">
                <div className="flex items-center mb-4">
                  ...
                  <h3 className="text-lg sm:text-xl font-bold text-gray-900">Food Security</h3>
                </div>
                <p className="text-gray-700 leading-relaxed text-sm sm:text-base">
            ...
            {/* Pride & Patriotism */}
            <Reveal delay={0.4}>
              <div className="bg-gradient-to-br from-yellow-50 to-amber-100 rounded-xl p-6 sm:p-8 border border-yellow-200">
                <div className="flex items-center mb-4">
                  <div className="w-10 h-10 sm:w-12 sm:h-12 bg-yellow-600 rounded-full flex items-center justify-center mr-3 sm:mr-4">
                    <span className="text-white text-lg sm:text-xl">🏆</span>
                  </div>
                  <h3 className="text-lg sm:text-xl font-bold text-gray-900">Pride & Patriotism</h3>
                </div>
                <p className="text-gray-700 leading-relaxed text-sm sm:text-base">
          ...
          <Reveal delay={0.5}>
            <div className="bg-gray-50 rounded-xl p-6 sm:p-8 mb-12 sm:mb-16">
              <h3 className="text-xl sm:text-2xl font-bold text-gray-900 mb-6 text-center">Our Path to Food Independence</h3>
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                <div className="text-center">
                  ...
                  <h4 className="font-semibold text-gray-900 mb-2 text-sm sm:text-base">Local Production</h4>
                  <p className="text-xs sm:text-sm text-gray-600">Partner with Ghanaian farmers to increase local food production capacity</p>
                </div>
                <div className="text-center">
                  <div className="w-12 h-12 sm:w-16 sm:h-16 bg-yellow-400 rounded-full flex items-center justify-center mx-auto mb-4">
                    <span className="text-white text-lg sm:text-2xl font-bold">2</span>
                  </div>
                  <h4 className="font-semibold text-gray-900 mb-2 text-sm sm:text-base">Value Chain Jobs</h4>
                  <p className="text-xs sm:text-sm text-gray-600">Create employment opportunities across the entire agricultural value chain</p>
                </div>
                <div className="text-center">
                  <div className="w-12 h-12 sm:w-16 sm:h-16 bg-yellow-400 rounded-full flex items-center justify-center mx-auto mb-4">
                    <span className="text-white text-lg sm:text-2xl font-bold">3</span>
                  </div>
                  <h4 className="font-semibold text-gray-900 mb-2 text-sm sm:text-base">Import Substitution</h4>
                  <p className="text-xs sm:text-sm text-gray-600">Replace imported food products with high-quality local alternatives</p>
                </div>
                <div className="text-center">
                  <div className="w-12 h-12 sm:w-16 sm:h-16 bg-yellow-400 rounded-full flex items-center justify-center mx-auto mb-4">
                    <span className="text-white text-lg sm:text-2xl font-bold">4</span>
                  </div>
                  <h4 className="font-semibold text-gray-900 mb-2 text-sm sm:text-base">Food Sovereignty</h4>
                  <p className="text-xs sm:text-sm text-gray-600">Build Ghana's capacity to feed itself with dignity and independence</p>
                </div>
              </div>
            </div>
          </Reveal>
          ...
          <Reveal delay={0.6}>
            <div className="bg-gradient-to-r from-red-600 to-yellow-600 rounded-xl p-6 sm:p-8 mb-12 sm:mb-16 text-center">
              <div className="text-3xl sm:text-4xl mb-4">🇬🇭</div>
              <blockquote className="text-xl sm:text-2xl font-bold text-white mb-4">
          ...
          <Reveal delay={0.7}>
            <div className="text-center">
              <h3 className="text-xl sm:text-2xl font-bold text-gray-900 mb-4">Join Ghana's Food Independence Movement</h3>
