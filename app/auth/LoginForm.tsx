...
export default function LoginForm() {
  ...
  const [digits, setDigits] = useState(""); // Ghana local part (9 digits)
  ...
  function onSubmit(e: React.FormEvent) {
    ...
    if (phase === "phone") {
      ...
      // Demo: show OTP step and display demo code inline
      setPhase("otp");
    } else {
      // Demo OTP validation
      if (otp !== "123456") {
  ...
  return (
    <form className="mt-6 grid gap-4" onSubmit={onSubmit}>
      ...
      >
        {phase === "phone" ? "Verify phone number" : "Confirm code & sign in"}
      </button>
