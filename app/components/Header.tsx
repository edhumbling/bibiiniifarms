      ...
      {open && (
        <div className="fixed inset-0 z-50">
          <div
            ...
            aria-hidden
          />
          <div className="absolute top-0 left-0 right-0 bg-happy-orange shadow-lg">
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-4">
              <div className="flex items-center justify-between mb-4">
                ...
                <button
                  ...
                  onClick={() => setOpen(false)}
                  className="inline-flex items-center justify-center h-8 w-8 hover:bg-white/10 rounded transition-colors"
                >
                ...
                {nav.map((item) => {
                  ...
                  return (
                    <Link
                      ...
                      onClick={() => setOpen(false)}
                      className={
                        "block px-4 py-2 rounded font-medium text-sm transition-colors " +
                        (active
