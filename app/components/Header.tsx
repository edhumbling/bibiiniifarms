                ...
                <div className="space-y-8">
                  <div className="space-y-4">
                    ...
                    <div className="flex space-x-4 pt-4">
                      ...
                      <a href="https://www.instagram.com/bibiniifarms?igsh=eHRrOGpicHU0MmRk&utm_source=qr" target="_blank" rel="noopener noreferrer" className="text-white hover:text-yellow-400 transition-colors" aria-label="Instagram">
                        <svg width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                      ...
                      <a href="https://www.tiktok.com/@bibinii.farms?_t=ZM-8yve1mnk2TN&_r=1" target="_blank" rel="noopener noreferrer" className="text-white hover:text-yellow-400 transition-colors" aria-label="TikTok">
                        <svg width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                      ...
                      <a href="https://wa.me/233543474770?text=Hello%20Bibinii%20Farms!%20I%27d%20like%20to%20place%20an%20order%20and%20get%20pricing%2C%20availability%2C%20and%20delivery%20options.%20Thank%20you." target="_blank" rel="noopener noreferrer" className="text-white hover:text-yellow-400 transition-colors" aria-label="WhatsApp">
                        <svg width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
