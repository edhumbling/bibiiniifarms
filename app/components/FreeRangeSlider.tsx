...
export default function FreeRangeSlider() {
  ...
  const autoplayRef = useRef(Autoplay({ delay: 4500, stopOnInteraction: false })); // Different delay
  ...
  if (!isMounted) {
    return (
      <div className="h-48 bg-gradient-to-br from-rose-50 to-red-100 rounded-lg overflow-hidden relative flex items-center justify-center">
        <span className="text-gray-600 text-lg font-semibold">Free Range</span>
      </div>
    );
  }
